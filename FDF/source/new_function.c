...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/10/02 18:01:16 by daron             #+#    #+#             */
/*   Updated: 2019/10/02 18:05:56 by daron            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_fdf			*new_fdf(t_map *map)
{
	...
	ptr->data_addr = mlx_get_data_addr(ptr->img,
...
t_camera		*new_camera(t_fdf *fdf)
{
	...
	ptr->y_offset = 0;
	ptr->z_divisor = 1;
	ptr->zoom = FT_MIN((WIDTH - MENU_WIDTH) / fdf->map->width / 2,
