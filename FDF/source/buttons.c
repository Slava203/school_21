...
/*   Updated: 2019/10/02 18:07:57 by daron            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			keyboard_press(int key, void *param)
{
	...
	key == ARROW_UP || key == ARROW_DOWN)
		move(key, fdf);
	else if (key == KEYBOARD_Q || key == KEYBOARD_A || key == KEYBOARD_W ||
	key == KEYBOARD_S || key == KEYBOARD_E || key == KEYBOARD_D)
		rotate(key, fdf);
	else if (key == KEYBOARD_1 || key == KEYBOARD_2 ||
